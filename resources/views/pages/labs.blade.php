        ...
        <div class=" col-xl-3 col-md-4 col-sm-6 col-xs-12">
              <div class="card card-box" style="width: 15rem;">
                ...
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#lap">{{ $lab['name'] }} Patient Services</button><a/>
                </div>
              </div>
        </div>
      </div>
      ...
      <div class="modal-body">  
         <div class="container">
          <div class="row">
             ...
             <div class="col-4">
             <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#vist-1"> Home Visit </button><a/><a/> 
             </div>
          </div>
         </div>
      </div>
